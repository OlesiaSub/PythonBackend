...
def check_expense_presence(expense_id: int, db: Session):
...
def check_available_storage_expense_id(expense_id: int, db: Session):
    if check_expense_presence(expense_id, db):
